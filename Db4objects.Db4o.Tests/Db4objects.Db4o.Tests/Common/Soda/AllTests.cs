	...
	public class AllTests : Db4oTestSuite
	{
		protected override Type[] TestCases()
		{
			return new Type[] { typeof(STOrderingTestCase), typeof(Db4objects.Db4o.Tests.Common.Soda.Arrays.AllTests
				...
				), typeof(OrderByParentFieldTestCase), typeof(OrderedOrConstraintTestCase), typeof(
				OrderFollowedByConstraintTestCase), typeof(QueryUnknownClassTestCase), typeof(SortMultipleTestCase
