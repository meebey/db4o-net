...
{
	public class FreespaceManagerDb4oMigrationTestCase : ITestCase
	{
		...
		{
			new ConsoleTestRunner(typeof(Db4objects.Db4o.Tests.Common.Freespace.FreespaceManagerDb4oMigrationTestCase
				)).Run();
		}

		public FreespaceManagerDb4oMigrationTestCase()
		{
		...
		private IList GetSlots(IFreespaceManager freespaceManager)
		{
			...
			freespaceManager.Traverse(new _IVisitor4_106(retVal));
			return retVal;
		}

		private sealed class _IVisitor4_106 : IVisitor4
		{
			public _IVisitor4_106(IList retVal)
			{
				this.retVal = retVal;
			}
