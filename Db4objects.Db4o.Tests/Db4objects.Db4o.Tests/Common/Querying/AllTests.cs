	...
	public class AllTests : Db4oUnit.Extensions.Db4oTestSuite
	{
		...
		protected override System.Type[] TestCases()
		{
			return new System.Type[] { typeof(Db4objects.Db4o.Tests.Common.Querying.IdListQueryResultTestCase)
				...
				, typeof(Db4objects.Db4o.Tests.Common.Querying.OrderedQueryTestCase), typeof(Db4objects.Db4o.Tests.Common.Querying.CascadedDeleteUpdate)
				...
				, typeof(Db4objects.Db4o.Tests.Common.Querying.CascadeToArray) };
		}
	}
}
