	...
	public class AllTests : Db4oTestSuite
	{
		...
		protected override Type[] TestCases()
		{
			return new Type[] { typeof(Db4objects.Db4o.Tests.Common.CS.Caching.AllTests), typeof(
				BatchActivationTestCase), typeof(CallConstructorsConfigTestCase), typeof(ClientDisconnectTestCase
				...
				), typeof(PrefetchConfigurationTestCase), typeof(PrimitiveMessageTestCase), typeof(
				QueryConsistencyTestCase), typeof(SendMessageToClientTestCase), typeof(ServerClosedTestCase
				...
				), typeof(SwitchingFilesFromMultipleClientsTestCase), typeof(SwitchingToFileWithDifferentClassesTestCase
				) };
		}
	}
}
