namespace Db4objects.Db4o.CS
{
	...
	{
		private readonly Db4objects.Db4o.CS.LazyClientQueryResult _queryResult;
		...
		public LazyClientIdIterator(Db4objects.Db4o.CS.LazyClientQueryResult queryResult)
		{
		...
		public virtual void LoadFromIdReader(Db4objects.Db4o.YapReader reader, int count)
		{
