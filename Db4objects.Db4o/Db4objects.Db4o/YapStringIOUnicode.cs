...
{
	/// <exclude></exclude>
	public sealed class YapStringIOUnicode : Db4objects.Db4o.YapStringIO
	{
		...
		{
			return Db4objects.Db4o.YapConst.UNICODE;
		}

		public override int Length(string a_string)
		{
			return (a_string.Length * 2) + Db4objects.Db4o.YapConst.OBJECT_LENGTH + Db4objects.Db4o.YapConst
				.INT_LENGTH;
		}

		public override string Read(Db4objects.Db4o.YapReader bytes, int a_length)
		{
		...
		{
			return (a_string.Length * 2) + Db4objects.Db4o.YapConst.INT_LENGTH;
		}

		public override void Write(Db4objects.Db4o.YapReader bytes, string @string)
		{
