namespace Db4objects.Db4o
{
	...
	/// </remarks>
	/// <exclude></exclude>
	public class QConstraints : Db4objects.Db4o.QCon, Db4objects.Db4o.Query.IConstraints
	{
		private Db4objects.Db4o.Query.IConstraint[] i_constraints;

		internal QConstraints(Db4objects.Db4o.Transaction a_trans, Db4objects.Db4o.Query.IConstraint[]
			 ...
			 a_with, bool a_and)
		{
			lock (StreamLock())
			{
				...
				return ((Db4objects.Db4o.QCon)a_with).Join1(this, a_and);
			}
		}
