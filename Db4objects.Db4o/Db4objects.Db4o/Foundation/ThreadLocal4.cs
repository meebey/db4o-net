...
namespace Db4objects.Db4o.Foundation
{
	...
	/// <see cref="Db4objects.Db4o.Foundation.DynamicVariable">Db4objects.Db4o.Foundation.DynamicVariable
	/// 	</see>
	/// .
	/// WARNING: This implementation might leak Thread references unless
	/// <see cref="Db4objects.Db4o.Foundation.ThreadLocal4.Set">Db4objects.Db4o.Foundation.ThreadLocal4.Set
	/// 	</see>
	...
	public class ThreadLocal4
	{
		...
		public virtual void Set(object value)
		{
			lock (this)
			{
				if (value == null)
				{
					Sharpen.Util.Collections.Remove(_values, Thread.CurrentThread());
				}
				else
				{
