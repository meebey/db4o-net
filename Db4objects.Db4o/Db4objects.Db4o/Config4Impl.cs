namespace Db4objects.Db4o
{
		...
		, Db4objects.Db4o.Config.IQueryConfiguration
	{
		...
		private static readonly Db4objects.Db4o.Foundation.KeySpec DIAGNOSTIC = new Db4objects.Db4o.Foundation.KeySpec
			(new Db4objects.Db4o.Inside.Diagnostic.DiagnosticProcessor());
		...
		private static readonly Db4objects.Db4o.Foundation.KeySpec ENCODING = new Db4objects.Db4o.Foundation.KeySpec
			(Db4objects.Db4o.YapConst.UNICODE);
		...
		private static readonly Db4objects.Db4o.Foundation.KeySpec FREESPACE_SYSTEM = new 
			Db4objects.Db4o.Foundation.KeySpec(Db4objects.Db4o.Inside.Freespace.FreespaceManager
			.FM_DEFAULT);
		...
		private static readonly Db4objects.Db4o.Foundation.KeySpec TIMEOUT_CLIENT_SOCKET = 
			new Db4objects.Db4o.Foundation.KeySpec(Db4objects.Db4o.YapConst.CLIENT_SOCKET_TIMEOUT
			);

		private static readonly Db4objects.Db4o.Foundation.KeySpec TIMEOUT_PING_CLIENTS = 
			new Db4objects.Db4o.Foundation.KeySpec(Db4objects.Db4o.YapConst.CONNECTION_TIMEOUT
			);

		private static readonly Db4objects.Db4o.Foundation.KeySpec TIMEOUT_SERVER_SOCKET = 
			new Db4objects.Db4o.Foundation.KeySpec(Db4objects.Db4o.YapConst.SERVER_SOCKET_TIMEOUT
			);
		...
		public void BlockSize(int bytes)
		{
			...
			{
				Db4objects.Db4o.Inside.Exceptions4.ThrowRuntimeException(1);
			}
			if (i_stream != null)
			{
				Db4objects.Db4o.Inside.Exceptions4.ThrowRuntimeException(46);
			}
		...
		{
			_config.Put(CALL_CONSTRUCTORS, (flag ? Db4objects.Db4o.YapConst.YES : Db4objects.Db4o.YapConst
				.NO));
		}
		...
		internal Db4objects.Db4o.Config4Class ConfigClass(string className)
		{
			Db4objects.Db4o.Config4Class config = (Db4objects.Db4o.Config4Class)ExceptionalClasses
				().Get(className);
			return config;
		}
		...
		public void Stream(Db4objects.Db4o.YapStream stream)
		{
			i_stream = stream;
		}
		...
		internal void EnsureDirExists(string path)
		{
			...
			{
				throw new System.IO.IOException(Db4objects.Db4o.Messages.Get(37, path));
			}
		}
		...
		{
			Db4objects.Db4o.Platform4.MarkTransient(marker);
		}
		...
		public Db4objects.Db4o.Config.IObjectClass ObjectClass(object clazz)
		{
			...
			Db4objects.Db4o.Config4Class c4c = (Db4objects.Db4o.Config4Class)xClasses.Get(className
				);
			if (c4c == null)
			{
				c4c = new Db4objects.Db4o.Config4Class(this, className);
		...
		internal Db4objects.Db4o.Reflect.Generic.GenericReflector Reflector()
		{
			...
			if (reflector == null)
			{
				...
				{
					configuredReflector = Db4objects.Db4o.Platform4.CreateReflector(ClassLoader());
		...
		private sealed class _AnonymousInnerClass412 : Db4objects.Db4o.Foundation.IVisitor4
		{
			...
			{
				Db4objects.Db4o.YapStream ys = ((Db4objects.Db4o.Session)obj).i_stream;
				if (!ys.IsClosed())
				{
					ys.RefreshClasses();
				}
		...
		private sealed class _AnonymousInnerClass451 : Db4objects.Db4o.Foundation.IVisitor4
		{
			...
			{
				Db4objects.Db4o.YapStream ys = ((Db4objects.Db4o.Session)session).i_stream;
				if (!ys.IsClosed())
				{
					ys.Send(session);
				}
		...
		{
			ReflectWith(Db4objects.Db4o.Platform4.CreateReflector(classLoader));
		}
		...
		{
			_config.Put(ENCODING, (unicodeOn ? Db4objects.Db4o.YapConst.UNICODE : Db4objects.Db4o.YapConst
				.ISO8859));
		}

		public void UpdateDepth(int depth)
		{
			Db4objects.Db4o.Inside.Diagnostic.DiagnosticProcessor dp = DiagnosticProcessor();
			if (dp.Enabled())
			{
		...
		{
			_config.Put(FREESPACE_SYSTEM, Db4objects.Db4o.Inside.Freespace.FreespaceManager.FM_RAM
				);
		}

		public void UseIndexSystem()
		{
			_config.Put(FREESPACE_SYSTEM, Db4objects.Db4o.Inside.Freespace.FreespaceManager.FM_IX
				);
		}
		...
		{
			clazz = Db4objects.Db4o.Platform4.GetClassForType(clazz);
		...
		public Db4objects.Db4o.Inside.Diagnostic.DiagnosticProcessor DiagnosticProcessor(
			)
		{
			return (Db4objects.Db4o.Inside.Diagnostic.DiagnosticProcessor)_config.Get(DIAGNOSTIC
				);
		}
