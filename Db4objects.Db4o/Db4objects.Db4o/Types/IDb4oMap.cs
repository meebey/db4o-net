...
namespace Db4objects.Db4o.Types
{
	...
	/// <see cref="IDb4oCollection.ActivationDepth(int)">IDb4oCollection.ActivationDepth(int)
	/// 	</see>
	/// .<br/>
	/// - removed objects can be deleted automatically, if the list is configured
	/// with
	/// <see cref="IDb4oCollection.DeleteRemoved(bool)">IDb4oCollection.DeleteRemoved(bool)
	/// 	</see>
	/// <br/><br/>
	/// Usage:<br/>
