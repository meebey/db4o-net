...
{
	/// <exclude></exclude>
	public class SlotChange : Db4objects.Db4o.TreeInt
	{
		private int _action;

		private Db4objects.Db4o.Inside.Slots.Slot _newSlot;

		private Db4objects.Db4o.Inside.Slots.ReferencedSlot _shared;
		...
		{
			Db4objects.Db4o.Inside.Slots.SlotChange sc = new Db4objects.Db4o.Inside.Slots.SlotChange
				(0);
			sc._action = _action;
		...
		public virtual void FreeDuringCommit(Db4objects.Db4o.YapFile file)
		{
			if (IsFreeOnCommit())
			{
		...
		public virtual void FreeOnCommit(Db4objects.Db4o.YapFile file, Db4objects.Db4o.Inside.Slots.Slot
			 slot)
		{
			if (_shared != null)
			{
			...
			DoFreeOnCommit();
			Db4objects.Db4o.Inside.Slots.ReferencedSlot refSlot = file.ProduceFreeOnCommitEntry
				(_key);
		...
		{
			DoFreeOnRollback();
			_newSlot = new Db4objects.Db4o.Inside.Slots.Slot(address, length);
		}
		...
		public virtual Db4objects.Db4o.Inside.Slots.Slot NewSlot()
		{
			return _newSlot;
		}

		public virtual Db4objects.Db4o.Inside.Slots.Slot OldSlot()
		{
			if (_shared == null)
			{
				return null;
		...
		public override object Read(Db4objects.Db4o.YapReader reader)
		{
			Db4objects.Db4o.Inside.Slots.SlotChange change = new Db4objects.Db4o.Inside.Slots.SlotChange
				(reader.ReadInt());
			change._newSlot = new Db4objects.Db4o.Inside.Slots.Slot(reader.ReadInt(), reader.
				ReadInt());
			change.DoSetPointer();
			return change;
		}

		public virtual void Rollback(Db4objects.Db4o.YapFile yapFile)
		{
			if (_shared != null)
			{
		...
		public override void Write(Db4objects.Db4o.YapReader writer)
		{
			if (IsSetPointer())
			{
		...
		public virtual void WritePointer(Db4objects.Db4o.Transaction trans)
		{
			if (IsSetPointer())
			{
