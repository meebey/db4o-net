namespace Db4objects.Db4o.Inside.Freespace
{
	...
	{
		internal Db4objects.Db4o.Inside.IX.Index4 _index;

		internal Db4objects.Db4o.Inside.IX.IndexTransaction _indexTrans;

		internal Db4objects.Db4o.Inside.IX.IxTraverser _traverser;

		internal Db4objects.Db4o.Inside.Freespace.FreespaceVisitor _visitor;

		internal FreespaceIx(Db4objects.Db4o.YapFile file, Db4objects.Db4o.MetaIndex metaIndex
			)
		{
			_index = new Db4objects.Db4o.Inside.IX.Index4(file.GetSystemTransaction(), new Db4objects.Db4o.YInt
		...
		{
			_traverser = new Db4objects.Db4o.Inside.IX.IxTraverser();
			_traverser.FindBoundsExactMatch(val, (Db4objects.Db4o.Inside.IX.IxTree)_indexTrans
				.GetRoot());
		}
		...
		{
			_visitor = new Db4objects.Db4o.Inside.Freespace.FreespaceVisitor();
