namespace Db4objects.Db4o.Inside.IX
{
	...
	internal class IxFileRange : Db4objects.Db4o.Inside.IX.IxTree
	{
		...
		public IxFileRange(Db4objects.Db4o.Inside.IX.IndexTransaction a_ft, int a_address
		...
		private Db4objects.Db4o.Inside.IX.IxFileRangeReader Reader()
		{
		...
		{
			Db4objects.Db4o.Inside.IX.IxFileRangeReader frr = Reader();
			if (lowerUpper == null)
			{
			...
			if (count > 0)
			{
				Db4objects.Db4o.YapReader fileReader = new Db4objects.Db4o.YapReader(count * frr.
					_slotLength);
		...
		public override int Write(Db4objects.Db4o.Inside.IX.IIndexable4 a_handler, Db4objects.Db4o.YapWriter
			 a_writer)
		{
			Db4objects.Db4o.YapFile yf = (Db4objects.Db4o.YapFile)a_writer.GetStream();
		...
		{
			Db4objects.Db4o.YapFile yf = Stream();
			Db4objects.Db4o.Transaction transaction = Trans();
			Db4objects.Db4o.YapReader fileReader = new Db4objects.Db4o.YapReader(SlotLength()
				);
		...
		public override void VisitFirst(Db4objects.Db4o.Inside.Freespace.FreespaceVisitor
			 visitor)
		{
			if (_preceding != null)
			{
		...
		public override void VisitLast(Db4objects.Db4o.Inside.Freespace.FreespaceVisitor 
			visitor)
		{
			if (_subsequent != null)
			{
		...
		{
			Db4objects.Db4o.Inside.IX.IxFileRangeReader frr = Reader();
			Db4objects.Db4o.YapReader fileReader = new Db4objects.Db4o.YapReader(frr._slotLength
				);
		...
		{
			Db4objects.Db4o.Inside.IX.IxFileRange range = new Db4objects.Db4o.Inside.IX.IxFileRange
