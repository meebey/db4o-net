...
{
	public class ReplicationProviderTest : Db4objects.Drs.Test.DrsTestCase
	{
		...
		{
			A().Provider().StoreNew(new Db4objects.Drs.Test.Pilot("Pilot1", 42));
			A().Provider().StoreNew(new Db4objects.Drs.Test.Pilot("Pilot2", 43));
			A().Provider().Commit();
			A().Provider().StoreNew(new Db4objects.Drs.Test.Pilot("Pilot3", 44));
			A().Provider().Delete(FindPilot("Pilot1"));
			Db4objects.Drs.Test.Car car = new Db4objects.Drs.Test.Car("Car1");
		...
		{
			System.Collections.IEnumerator cars = A().Provider().GetStoredObjects(typeof(Db4objects.Drs.Test.Car)
				).GetEnumerator();
			while (cars.MoveNext())
			{
				Db4objects.Drs.Test.Car candidate = (Db4objects.Drs.Test.Car)cars.Current;
		...
		private Db4objects.Drs.Test.Pilot FindPilot(string name)
		{
			System.Collections.IEnumerator pilots = A().Provider().GetStoredObjects(typeof(Db4objects.Drs.Test.Pilot)
				).GetEnumerator();
			while (pilots.MoveNext())
			{
				Db4objects.Drs.Test.Pilot candidate = (Db4objects.Drs.Test.Pilot)pilots.Current;
		...
		private Db4objects.Drs.Test.SPCChild GetOneChildFromA()
		{
			Db4objects.Db4o.IObjectSet storedObjects = A().Provider().GetStoredObjects(typeof(Db4objects.Drs.Test.SPCChild)
				);
			...
			return (Db4objects.Drs.Test.SPCChild)iterator.Current;
		}
		...
		private void TstObjectUpdate()
		{
			...
			A().Provider().Commit();
			StartReplication();
			Db4objects.Drs.Test.SPCChild reloaded = GetOneChildFromA();
			long oldVer = A().Provider().ProduceReference(reloaded, null, null).Version();
			CommitReplication();
			Db4objects.Drs.Test.SPCChild reloaded2 = GetOneChildFromA();
			reloaded2.SetName("c3");
			A().Provider().Update(reloaded2);
			A().Provider().Commit();
			StartReplication();
			Db4objects.Drs.Test.SPCChild reloaded3 = GetOneChildFromA();
		...
		{
			Db4objects.Drs.Test.Pilot object1 = new Db4objects.Drs.Test.Pilot("John Cleese", 
				42);
			Db4objects.Drs.Test.Pilot object2 = new Db4objects.Drs.Test.Pilot("Terry Gilliam"
				, 53);
			Db4objects.Drs.Test.Car object3 = new Db4objects.Drs.Test.Car("Volvo");
			...
			Db4objects.Db4o.IObjectSet os = A().Provider().ObjectsChangedSinceLastReplication
				(typeof(Db4objects.Drs.Test.Pilot));
			Db4oUnit.Assert.AreEqual(os.Count, 2);

			//System.Collections.IEnumerator pilots = os.GetEnumerator();
            Db4objects.Db4o.IObjectSet cars = A().Provider().ObjectsChangedSinceLastReplication(typeof(Db4objects.Drs.Test.Car));
			Db4oUnit.Assert.IsTrue(cars.HasNext());
			Db4oUnit.Assert.AreEqual(((Db4objects.Drs.Test.Car)cars.Next()).GetModel(), "Volvo"
				);
			...
			CommitReplication();
			Db4objects.Drs.Test.Pilot pilot = (Db4objects.Drs.Test.Pilot)A().Provider().GetStoredObjects
				(typeof(Db4objects.Drs.Test.Pilot)).Next();
			pilot._name = "Terry Jones";
			Db4objects.Drs.Test.Car car = (Db4objects.Drs.Test.Car)A().Provider().GetStoredObjects
				(typeof(Db4objects.Drs.Test.Car)).Next();
			...
			Db4oUnit.Assert.AreEqual(A().Provider().ObjectsChangedSinceLastReplication().Count
				, 2);
            Db4objects.Db4o.IObjectSet pilots = A().Provider().ObjectsChangedSinceLastReplication(typeof(Db4objects.Drs.Test.Pilot)
				);
			Db4oUnit.Assert.AreEqual(((Db4objects.Drs.Test.Pilot)pilots.Next())._name, "Terry Jones"
				);
			Db4oUnit.Assert.IsFalse(pilots.HasNext());
			cars = A().Provider().ObjectsChangedSinceLastReplication(typeof(Db4objects.Drs.Test.Car)
				);
			Db4oUnit.Assert.AreEqual(((Db4objects.Drs.Test.Car)cars.Next()).GetModel(), "McLaren"
				);
			Db4oUnit.Assert.IsFalse(cars.HasNext());
			CommitReplication();
			A().Provider().DeleteAllInstances(typeof(Db4objects.Drs.Test.Pilot));
			A().Provider().DeleteAllInstances(typeof(Db4objects.Drs.Test.Car));
			A().Provider().Commit();
		}

		private void TstReferences()
		{
			A().Provider().StoreNew(new Db4objects.Drs.Test.Pilot("tst References", 42));
			A().Provider().Commit();
			StartReplication();
			Db4objects.Drs.Test.Pilot object1 = (Db4objects.Drs.Test.Pilot)A().Provider().GetStoredObjects
				(typeof(Db4objects.Drs.Test.Pilot)).Next();
			...
			Db4objects.Drs.Inside.IReplicationReference ref2 = A().Provider().ProduceReferenceByUUID
				(uuid, typeof(Db4objects.Drs.Test.Pilot));
		...
		private void TstRollback()
		{
			...
			StartReplication();
			Db4objects.Drs.Test.Pilot object1 = new Db4objects.Drs.Test.Pilot("Albert Kwan", 
				25);
		...
		private void TstStore()
		{
			...
			CommitReplication();
			StartReplication();
			System.Collections.IEnumerator storedObjects = A().Provider().GetStoredObjects(typeof(Db4objects.Drs.Test.Pilot)
				).GetEnumerator();
			Db4oUnit.Assert.IsTrue(storedObjects.MoveNext());
			Db4objects.Drs.Test.Pilot reloaded = (Db4objects.Drs.Test.Pilot)storedObjects.Current;
			...
			Db4oUnit.Assert.AreEqual(((Db4objects.Drs.Test.Pilot)reference.Object())._name, "i am updated"
				);
			CommitReplication();
			A().Provider().DeleteAllInstances(typeof(Db4objects.Drs.Test.Pilot));
			A().Provider().Commit();
