...
namespace Db4objects.Drs.Test
{
	public class Db4oTests : Db4objects.Drs.Test.DrsTestSuite
	{
		...
		{
			int failureCount = new Db4objects.Drs.Test.Db4oTests().Rundb4oCS();
			failureCount = failureCount + new Db4objects.Drs.Test.Db4oTests().RunCSCS();
			return failureCount;
		}
		...
		{
			return new Db4oUnit.TestRunner(new Db4objects.Drs.Test.DrsTestSuiteBuilder(new Db4objects.Drs.Test.Db4oClientServerDrsFixture
		...
		{
			return new Db4oUnit.TestRunner(new Db4objects.Drs.Test.DrsTestSuiteBuilder(new Db4objects.Drs.Test.Db4oDrsFixture
		...
		{
			return new System.Type[] { typeof(Db4objects.Drs.Test.Dotnet.StructTestCase) };
		}
